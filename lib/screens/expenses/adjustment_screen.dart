                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: AppTheme.warningYellow.withAlpha(80),
                          width: 2),
                    ),
                    child: const Center(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _CalcRow(
                          ...
                          value:
                              '\$${overspend > 0 ? overspend.toStringAsFixed(2) : '0.00'}',
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Text(value,
            style: AppTheme.titleMedium.copyWith(color: color, fontSize: 14)),
      ],
    );
  }
}
