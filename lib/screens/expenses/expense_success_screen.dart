...
class ExpenseSuccessScreen extends StatefulWidget {
  ...
  final double amount;
  const ExpenseSuccessScreen({super.key, required this.category, required this.amount});
...
class _ExpenseSuccessScreenState extends State<ExpenseSuccessScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final catColor = AppTheme.categoryColors[widget.category] ?? AppTheme.primary;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text('Great job tracking your spending.', style: AppTheme.bodyMedium),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text('$catEmoji ${widget.category}', style: AppTheme.titleMedium),
                    ...
                    Row(
                      ...
                      children: [
                        _SummaryRow(label: 'Remaining today', value: '\$${budget.todayRemaining.toStringAsFixed(2)}'),
                        _SummaryRow(label: 'Monthly left', value: '\$${budget.monthlyRemaining.toStringAsFixed(2)}'),
                      ],
                    ),
                  ],
                ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: AppTheme.bodyMedium.copyWith(fontSize: 13, color: AppTheme.dangerRed),
                        ),
                      ),
                    ],
                  ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    if (isOverspent) {
                      Navigator.pushReplacementNamed(context, '/adjustment');
                    } else {
                      Navigator.pushNamedAndRemoveUntil(context, '/home', (_) => false);
                    }
                  },
                  child: Text(isOverspent ? 'See Adjustment' : 'Back to Dashboard',
