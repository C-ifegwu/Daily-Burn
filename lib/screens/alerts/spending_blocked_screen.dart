            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppTheme.dangerRed.withAlpha(60), width: 2),
                ),
                child: const Icon(Icons.block_rounded, color: AppTheme.dangerRed, size: 56),
              ),
              const SizedBox(height: 32),
              Text('Budget Exhausted', style: AppTheme.headlineMedium, textAlign: TextAlign.center),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppTheme.dangerRed.withAlpha(40), width: 1),
                ),
                child: Column(
                  children: [
              ...
              const Spacer(),
              DailyBurnButton(label: 'Go Home', onTap: () => Navigator.pushNamedAndRemoveUntil(context, '/home', (_) => false)),
              const SizedBox(height: 12),
              DailyBurnButton(label: 'Adjust Budget', onTap: () => Navigator.pushNamed(context, '/input-budget'), isPrimary: false),
              const SizedBox(height: 8),
            ],
          ),
        ),
